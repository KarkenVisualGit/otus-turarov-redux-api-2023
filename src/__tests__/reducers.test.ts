...
describe("cartReducer", () => {
  it("handles ADD_TO_CART action", () => {
    ...
    const action = {
      type: ActionTypes.ActionTypesCart.ADD_TO_CART,
  ...
  it("handles REMOVE_FROM_CART action", () => {
    ...
    const action = {
      type: ActionTypes.ActionTypesCart.REMOVE_FROM_CART,
      payload: "1",
    };
  ...
  it("handles UPDATE_QUANTITY action", () => {
    ...
    const action = {
      type: ActionTypes.ActionTypesCart.UPDATE_QUANTITY,
  ...
  it("handles SELECT_PRODUCT action", () => {
    ...
    const action = {
      type: ActionTypes.ActionTypesCart.SELECT_PRODUCT,
      payload: "1",
    };
    const expectedState = {
